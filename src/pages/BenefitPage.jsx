...
import TableBenefit from "@/components/table/TableBenefit";
...
const BenefitPage = () => {
  ...
  const { data } = useSWR(tmdbAPI.getAPI("benefit"), fetcher);
  console.log(data);
  const employee = data || [];
  // handle next page
    ...
    <Fragment>
      <div className="py-7 px-10">
        <div className="flex justify-between">
          <TitleContent
            mainChildren={"Employee Benefit"}
            minorCirldren={"Memo / Benefit"}
          ></TitleContent>
          <div className="">
            <button
